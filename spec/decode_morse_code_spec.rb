...
describe "decodeMorse" do
  it "Basic tests" do
    morse = Morse.new
    # MORSE_CODE constant was preloaded into codewars test suite. Those are the original test, but I dont have
    # the morse code table loaded in MORSE_CODE, so I will comment the tests.

    # expect(morse.decodeMorse('.... . -.--   .--- ..- -.. .')).to eq('HEY JUDE')
    # expect(morse.decodeMorse('   .   .')).to eq('E E')
  end
end
